package com.parthjadav.nfcreaderexample.nfc;
...
public class UriRecord implements ParsedNdefRecord {
    ...
    /**
     * Scanner Forum "URI Record Type Definition"
     *
     * This is a mapping of "URI Identifier Codes" to URI string prefixes,
     * per section 3.2.2 of the Scanner Forum URI Record Type Definition document.
     */
    ...
    private static UriRecord parseWellKnown(NdefRecord record) {
         ...
         * Scanner Forum "URI Record Type Definition" section 3.2.2.
         *
